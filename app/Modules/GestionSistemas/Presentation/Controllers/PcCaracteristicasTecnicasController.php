...
use App\Modules\GestionSistemas\Infrastructure\Repositories\PcCaracteristicasTecnicasRepository;

class PcCaracteristicasTecnicasController extends Controller
{
    private PcCaracteristicasTecnicasRepository $repository;
    private PermissionService $permissionService;

    public function __construct(PermissionService $permissionService)
    {
        $this->repository = new PcCaracteristicasTecnicasRepository();
        $this->permissionService = $permissionService;
    }

    #[OA\Get(
        path: '/api/gestion-sistemas/pc-caracteristicas-tecnicas',
        tags: ['PcCaracteristicasTecnicas (DDD)'],
    ...
    #[OA\Get(
        path: '/api/gestion-sistemas/pc-caracteristicas-tecnicas/{id}',
        tags: ['PcCaracteristicasTecnicas (DDD)'],
    ...
    #[OA\Get(
        path: '/api/gestion-sistemas/pc-caracteristicas-tecnicas/equipo/{equipo_id}',
        tags: ['PcCaracteristicasTecnicas (DDD)'],
