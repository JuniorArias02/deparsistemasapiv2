...
class NuevoTicketCreadorMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Confirmación de Ticket #' . $this->sugerencia->codigo_ticket . ' - NexaCore',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.buzonSugerencias.notificacion_creador',
        );
    }
